...
model.component('comp1').physics('mbd').feature('rd1').feature('init1').set('phi', 'phi');
model.component('comp1').physics('mbd').feature('rd1').feature('init1').set('phit', 'phi_t');
% all | first |last | interp | manual
M = mphstate(model,'sol1','out',{'Mc' 'MA' 'MB' 'A' 'B' 'C' 'D' 'x0', 'Null', 'ud'},'input', {'M0'}, 'output', {'comp1.dom1','comp1.dom2'}, 'sparse', 'off', 'initmethod', 'sol','solnum',1);
model.sol('sol1').runAll;
